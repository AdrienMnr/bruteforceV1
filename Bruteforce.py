...
if choix == 1 :
	...
	print (" Vous avez décider une attaque Bruteforce SSH classique")


elif choix == 3 :
	print (" Vous avez choisi une attaque  Brutefroce Web par bibliothèque ")

elif choix == 4 :
	print (" Vous avez choisi une attaque Bruteforce Web classique ")
